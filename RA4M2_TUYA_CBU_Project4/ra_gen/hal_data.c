...
/* Actual period: 0.001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x15f90,
  .duty_cycle_counts = 0xafc8, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = NULL,
